 ...
 <form class="navbar-form navbar-right" role="search">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <div class="well well-lg offer-box text-center">
                   ...
                   Today's Offer : &nbsp; <span class="glyphicon glyphicon-cog"></span>&nbsp;40 % off  on purchase of &#8377 2,000 and above till 24 dec !                
            ...
            <div class="col-md-3 text-center">
                <div class=" col-md-12 col-sm-6 col-xs-6" >
                    <div class="offer-text">
                     ...
                     <div class="thumbnail product-box">
                        <img src="assets/img/lico.jpg" alt="" />
                        <div class="caption">
                            <h3><a href="#">Leco mobiles </a></h3>
                ...
                <div class=" col-md-12 col-sm-6 col-xs-6">
                    ...
                    <div class="thumbnail product-box">
                        <img src="assets/img/motox1.jpg" alt="" />
                        <div class="caption">
                            <h3><a href="#">MotoX</a></h3>
      ...
      <span class="label label-primary pull-right">234</span>
                ...
                <!-- /.div -->
                <div>
                    <a href="#" class="list-group-item active">Accessories & Extras
                    </a>
                    <ul class="list-group">
                        <li class="list-group-item">Mobile Accessories
                             <span class="label label-warning pull-right">456</span>
                        </li>
                        <li class="list-group-item">Men's Accessaories
               ...
               <!-- /.row -->
                <div class="row">
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="assets/img/shirt.jpeg" alt="" />
                            <div class="caption">
                                <h3><a href="bankdetails.php">Highlander Shirt</a></h3>
                                <p>Price : <strong> ₹ 500  </strong>  </p>
                                <p><!-- Trigger/Open The Modal -->
<button id="myBtn" class="btn btn-success" role="button">Buy Now</button>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <br>
    <p><a href="bankdetails.php" class="btn btn-success" role="button">Net Banking</a> </p>
    <br>
    <p>
    <a href="#" class="btn btn-success" role="button">COD</a> </p>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                             <img src="assets/img/pant7.jpg" alt="" />
                            <div class="caption">
                                <h3><a href="bankdetails.php">Levi jeans </a></h3>
                                <p>Price : <strong> ₹ 2,500</strong>  </p>
                               <p><a href="bankdetails.php" class="btn btn-success" role="button">Buy Now</a> 
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="assets/img/hyper.jpg" alt="" />
							<br/>
							
                            <div class="caption">
                                <h3><a href="bankdetails.php">Nike Hypervenom</a></h3>
                                <p>Price : <strong> ₹ 5,000</strong>  </p>
                                
                                <p><a href="bankdetails.php" class="btn btn-success" role="button">Buy Now</a>                             </div>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
      ...
      <span class="caret"></span>
                ...
                <div class="row">
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="assets/img/motoz.jpg" alt="" />
                            <div class="caption">
                                <h3><a href="bankdetails.php">Moto Z</a></h3>
                                <p>Price : <strong> ₹ 15,999</strong>  </p>
                                
                                <p>
                                    <a href="bankdetails.php" class="btn btn-success" role="button">Buy Now</a>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="assets/img/on74.jpg" alt="" />
                            <div class="caption">
                                <h3><a href="bankdetails.php">Samsung Galaxy </a></h3>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="assets/img/lico.jpg" alt="" />
                            <div class="caption">
                                <h3><a href="bankdetails.php">LecoTV</a></h3>
                                <p>Price : <strong> ₹ 11,999</strong>  </p>
    ...
    <div class="col-md-12 download-app-box text-center">
        ...
        <span class="glyphicon glyphicon-download-alt"></span>Download Our Android App and Get 20% additional Off on all Products . <a href="#" class="btn btn-danger btn-lg">DOWNLOAD  NOW</a>
    ...
    <div class="col-md-12 footer-box">
       ...
       <div class="row small-box ">
            ...
            <a href="#">Oneplus</a> |  <a href="#">Iphone</a> | <a href="#">Oppo</a> |<a href="#">Vivo</a> |
              <a href="#">Sony</a> | <a href="#">Microx</a> |<a href="#">samsung</a> |  <a href="#">Sony</a> | 
            <a href="#">Moto</a> |<a href="#">Xaomi</a> |  <a href="#">ZTE</a> | <a href="#">Nokia</a> |
              view all items
         
        </div>
        <div class="row small-box ">
            <strong>Laptops :</strong> <a href="#">ASUS</a> |  <a href="#">Sony</a> | <a href="#">Microx Laptops</a> | 
            <a href="#">Macbook</a> |  <a href="#">DELL</a> | <a href="#">Acer</a> |<a href="#">Lenovo</a> |
               <a href="#">samsung</a> |  <a href="#">HP</a> | 
             view all items
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>
                    ...
                    Email: info@buyoshop.com<br>
                </p>

                2017 www.buyoshop.com | All Right Reserved
            </div>
            <div class="col-md-4 social-box">
                ...
                <p>
                   Providing Online Security since 2016.Our goal is to provide everyone with secure online shopping environment.
                </p>
            </div>
        </div>
        <hr>
    ...
    <div class="col-md-12 end-box ">
        &copy; 2017 | &nbsp; All Rights Reserved | &nbsp; www.buyoshop.com | &nbsp; 24x7 support | &nbsp; Email us: info@buyoshop.com
    </div>
    <!-- /.col -->
    <!--Footer end -->
