 ...
 <form class="navbar-form navbar-right" role="search">
	...
	<form class="form-signin" method="POST">
       ...
       <div class="input-group">
	     ...
	     <input list="bankName" type="text" name="bankName" class="form-control" placeholder="bankName" required>
...
<br>
    ...
    <div class="col-md-12 end-box ">
        &copy; 2017 | &nbsp; All Rights Reserved | &nbsp; | &nbsp; 24x7 support | &nbsp; Email us: buyoshop@gmail.com
    </div>
    <!-- /.col -->
    <!--Footer end -->
