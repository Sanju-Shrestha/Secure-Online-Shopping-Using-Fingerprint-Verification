...
<body>
<!-- Progress bar holder -->
<div id="progress" style="width:500px;border:3px solid #000000;"></div>
...
for($i=1; $i<=$total; $i++){
  ...
  document.getElementById("progress").innerHTML="<div style=\"width:'.$percent.';background-color:#B0E0E6;\">&nbsp;</div>";
...
echo '<script language="javascript">document.getElementById("information").innerHTML="Transaction completed <br/> Please check your mail for confirmation"</script>';

echo '<script> window.location.replace("http://192.168.43.180/welcome.php");</script>';
sleep(1);
}
?>
