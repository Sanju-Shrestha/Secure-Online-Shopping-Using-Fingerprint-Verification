...
?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#"><strong>Mail: </strong>info@multimodalsecurity.com</a></li>
                            <li class="divider"></li>
            ...
            <div class="col-md-3 text-center">
                ...
                <div class=" col-md-12 col-sm-6 col-xs-6">
                    ...
                    <div class="thumbnail product-box">
                        <img src="assets/img/dummyimg.png" alt="" />
                        <div class="caption">
                            <h3><a href="#">Samsung Galaxy S2 </a></h3>
                ...
                <div class="row">
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                <h3><a href="#">Samsung Galaxy S2</a></h3>
                                <p>Price : <strong>&#8377 25,000</strong>  </p>
                                
                                <p><a href="bankdetails.php" class="btn btn-success" role="button">Buy Now</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="assets/img/dummyimg.png" alt="" />
                            <div class="caption">
                                <h3><a href="#">Samsung Galaxy 3</a></h3>
                                <p>Price : <strong>&#8377 35,900</strong>  </p>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            <img src="assets/img/dummyimg.png" alt="" />
                            <div class="caption">
                                <h3><a href="#">Samsung Galaxy 7 </a></h3>
                                <p>Price : <strong>&#8377 45,900</strong>  </p>
                    ...
                    <div class="col-md-4 text-center col-sm-6 col-xs-6">
                        <div class="thumbnail product-box">
                            ...
                            <div class="caption">
                                ...
                                <p>Price : <strong>&#8377 3,45,900</strong>  </p>
                                <p>
                                    <p><a href="bankdetails.php" class="btn btn-success" role="button">Buy Now</a></p>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p>
                    ...
                    Email: info@multimodalsecurity.com<br>
                </p>

                2017 www.mmsecurity.com | All Right Reserved
            </div>
